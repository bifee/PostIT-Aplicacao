...
void Janela::CriarPostitTrab()
{
    ...
    while (!certo)
    {
        ...
        {
            QMessageBox::critical(this, "ERRO", "Data invalida, digite novamente");
        }
    }
...
void Janela::CriarPostitcompromisso()
{
    ...
    while (!horariocerto)
    {
        try
        {
            ...
            for (int j = 3; j < 5; j++)
            {
                if (horario[2] != ':' || !horario[j].isDigit())
                {
                    throw 1;
                }
            }
        ...
        {
            QMessageBox::critical(this, "ERRO", "Horario invalido, digite novamente");
        }
    }
